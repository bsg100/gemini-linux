...
| 9 | Optional hardware | **Started 2026-07-16.** Touchscreen **WORKING 2026-07-19** (build #266): Solomon SSD2092 on i2c4/0x53, new polled driver `input/0002`; details boot.md builds #263–#266, driver_ports.md SSD2092 entry. Remaining candidates: audio, suspend/resume, sensors, GPS, camera, LTE; Bluetooth blocked on parked CONSYS (B-21). LXQt desktop **WORKING 2026-07-19** (userspace only, no boot change — `startx` on demand): fbdev-rotated landscape X + touch; full findings in research.md section 9. |
